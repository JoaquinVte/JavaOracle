...
public class CargarDatos extends javax.swing.JFrame {
     ...
     */
    public CargarDatos(String fichero) {
        initComponents();
        jLabel3.setText("RESULTADO CARGA DE FICHERO " + fichero);
        CargarLoader(fichero);
    }
    
    private void CargarLoader(String fichero)
    {
        showMessageDialog(null, "DESARROLLA LA LLAMADA AL PROCEDURE DE CARGAR LOADER, Ejercicio 4.6 e imprímelo en un jTable todos los errores que genere. DEL MISMO ESTILO QUE JugadoreEquipo.java");        
    }
